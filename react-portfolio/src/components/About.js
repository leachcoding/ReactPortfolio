      ...
      <div id='about'className='about'>
        ...
        <div className='aboutTop'>
          ...
          <div className='aboutText'>
            <p>Hey, I'm Jay, a(n) <span id="sequenceText">developer</span>. Currently a <a href='https://www.w3schools.com/whatis/whatis_fullstack.asp'>Full Stack Developer</a> for <a href='https://www.pitttechnologygroup.com/'>Pitt Technology Group</a>. I was formerly a developer at <a href='https://frontiermedialabs.com/'>Frontier Media</a> and a <a href='https://en.wikipedia.org/wiki/Lead_programmer'>Team Lead</a> at <a href='https://lambdaschool.com/'>Lambda School</a>.</p>
            <p>I love writing clean, semantic code that is accessible to all. Technology drives me and I love creating scalable solutions to connect the old world to the new. As a developer, I am always looking to learn, try new things, and push the boundaries of what I know. I strive to be the best I can be and have my work reflect the passion I feel for software development.</p>
